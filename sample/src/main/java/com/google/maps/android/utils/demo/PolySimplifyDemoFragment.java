...
import com.airbnb.android.airmapview.utils.PolyUtil;
...
public class PolySimplifyDemoFragment extends BaseDemoFragment {
    ...
    protected void startDemo() {
        ...
        mMap.addPolygon(new AirMapPolygon.Builder(new PolygonOptions()
                .addAll(triangle)
