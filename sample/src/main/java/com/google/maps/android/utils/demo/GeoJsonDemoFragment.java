...
import com.airbnb.android.airmapview.utils.geojson.GeoJsonFeature;
import com.airbnb.android.airmapview.utils.geojson.GeoJsonLayer;
import com.airbnb.android.airmapview.utils.geojson.GeoJsonPointStyle;
...
public class GeoJsonDemoFragment extends BaseDemoFragment {
    ...
    private void addColorsToMarkers() {
        ...
        for (GeoJsonFeature feature : mLayer.getFeatures()) {
            ...
            if (feature.hasProperty("mag") && feature.getProperty("mag") != null && feature.hasProperty("place")) {
